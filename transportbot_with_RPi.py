...
#def setup():
IO.setmode (IO.BCM)
IO.setup(MotorR_Dir,IO.OUT)          #GPIO 23 = BOARD 16
IO.setup(MotorL_Dir,IO.OUT)          #GPIO 24 = BOARD 18
IO.setup(MotorR_Speed,IO.OUT)
IO.setup(MotorL_Speed,IO.OUT)
R = IO.PWM(MotorR_Speed,100)         #GPIO 12 = BOARD 32
L = IO.PWM(MotorL_Speed,100)         #GPIO 12 = BOARD 33.
R.start(0)
L.start(0)
i=0
...
def forward():    
    ...
    IO.output(MotorR_Speed,IO.HIGH)
    IO.output(MotorL_Speed,IO.HIGH)
def halt():    
    R.ChangeDutyCycle(0)
    L.ChangeDutyCycle(0)
    IO.output(MotorR_Speed,IO.HIGH)
...
def slight_left():
    ...
    IO.output(MotorR_Speed,IO.HIGH)
    IO.output(MotorL_Speed,IO.LOW)


def slight_right():
    R.ChangeDutyCycle(25)
    L.ChangeDutyCycle(50)
    IO.output(MotorR_Speed,IO.LOW)
    IO.output(MotorL_Speed,IO.HIGH)
